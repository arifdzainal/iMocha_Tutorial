...
this.aanFeatures=[];this.oLanguage={sProcessing:"Proses...",sLengthMenu:"Show _MENU_ record",sZeroRecords:"No result found",sInfo:"Show _START_ to _END_ from _TOTAL_ records",sInfoEmpty:"No result found",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sSearch:"Search:",sUrl:"",oPaginate:{sFirst:"First",sPrevious:"<",sNext:">",sLast:"Last"}};
...
this._iDisplayLength=15;this._iDisplayStart=0;this._iDisplayEnd=15;this._iRecordsTotal=0;
...
var sStdMenu='<select size="1" '+sName+'><option value="10">10</option><option value="15">15</option><option value="25">25</option><option value="50">50</option><option value="100">100</option><option value="1000">1000</option></select>';
